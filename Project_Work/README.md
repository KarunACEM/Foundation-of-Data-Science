...
Team Name: FOD-Team  
Members:  
- Karun Rajbanshi (Roll No: ACE081BCT035)
...
The target variable Loan_Status contains two classes (Approved / Not Approved).

Logistic Regression is suitable for binary classification problems.

The model estimates the probability of loan approval based on applicant features.
...
Dataset obtained from Kaggle — Loan Prediction Problem Dataset(https://www.kaggle.com/datasets/altruistdelhite04/loan-prediction-problem-dataset)